 ...
 * a companion can include this file and reuse mapped_places_dev_create_map_page().
 */

if (!function_exists('mapped_places_dev_create_map_page')) {
    /**
     ...
     * @return int Page ID.
     */
    function mapped_places_dev_create_map_page($title, $slug, array $settings, $widget = 'mapped_places_map') {
        $data = array(array(
...
if (!defined('MAPPED_PLACES_DEV_PAGES_LIBRARY')) {
    $map = mapped_places_dev_create_map_page('Map', 'map', array(
